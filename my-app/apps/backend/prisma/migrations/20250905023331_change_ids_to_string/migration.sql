/*
  ...
  - The primary key for the `SizeGuide` table will be changed. If it partially fails, the table could be left without primary key constraint.
...
-- AlterTable
ALTER TABLE "public"."ResetToken" ALTER COLUMN "userId" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "public"."SizeGuide" DROP CONSTRAINT "SizeGuide_pkey",
ALTER COLUMN "id" DROP DEFAULT,
ALTER COLUMN "id" SET DATA TYPE TEXT,
ADD CONSTRAINT "SizeGuide_pkey" PRIMARY KEY ("id");
DROP SEQUENCE "SizeGuide_id_seq";
