...
// Datos de las categorías circulares PARA MUJER
const subcategories = [
  {
    name: 'Remeras',
    slug: 'remeras',
...
export default function MujerPage() {
  ...
  return (
    <div className="max-w-full mx-auto px-4 py-14 bg-white min-h-screen">
      ...
      {/* Encabezado */}
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-1">ROPA PARA MUJER +</h1>
            ...
            <div className="text-center py-20 bg-gray-50 rounded-lg">
              ...
              <p className="text-gray-400 mb-6">
                {selectedSubcategory 
                  ...
                  : 'No hay productos en la categoría mujer aún'
                }
              </p>
              {selectedSubcategory ? (
                <button 
